  ...
  const steps = [
    {
      title: "Нэгдэх",
      description:
        "Өөрийгөө сорьж арилжаанд оролцохыг шийдсэн танд манайд нэгдэж байгаад баяр хүргэе!",
      buttonLabel: "Нэгдэх",
      icon: "🚀",
    },
    {
    ...
    },
    {
      title: "Суралцах",
      description:
        "Өөрийнхөө арилжааны аргачлалд тохирсон хичээлүүдийг үзэж зах зээлд оролцох бэлтгэлээ хангаарай",
